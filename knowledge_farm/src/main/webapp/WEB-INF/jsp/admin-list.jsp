        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock>
	            ...
	            <a href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.pageNumber}&&pageSize=${adminPage.pageSize}&&exist=1">
          ...
          <!-- 分页处理开始 -->
			  ...
			  <div align="center">
				...
				<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${prePage}&&pageSize=${adminPage.pageSize}&&exist=1">上一页</a>
				<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${nextPage}&&pageSize=${adminPage.pageSize}&&exist=1">下一页</a>
				<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${lastPage}&&pageSize=${adminPage.pageSize}&&exist=1">末页</a>
			  </div>
