			...
			layer.confirm('确认要删除吗？',function(index){
				if(id != "${admin.id}"){
					$.post("${ctx}/admin/deleteOneAdmin",{"id":id},function(data){
		    			if(data == "succeed"){
		    				window.location.href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.currentPageNum}&&pageSize=${adminPage.pageSize}&&exist=${param.exist}";
		    			}else if(data == "fail"){
		    				layer.msg('删除失败');
		    			}
		    		})   
        ...
        <div class="page-content">
          <div class="content">
                ...
                <div class="layui-form-pane" style="text-align: center;">
                  <div class="layui-form-item" style="display: inline-block;">
                    <div class="layui-input-inline">
                      <input type="text" name="account" placeholder="请输入管理员账号" autocomplete="off" class="layui-input" value="${param.account}">
                      <input type="hidden" name="exist" value="${param.exist}"/>
                    </div>
            ...
            <xblock>
	            ...
	            <button class="layui-btn" onclick="addAdmin('添加管理员','${ctx}/admin/toAdd','600','500')">
	            	<i class="layui-icon">&#xe608;</i>添加
	            </button>
	            <a href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.currentPageNum}&&pageSize=${adminPage.pageSize}&&exist=${param.exist}">
                	...
                	<c:forEach var="adminPage" items="${adminPage.list}">
	                    <tr>
	                        ...
	                        <td class="td-manage" align="center">
	                            <a style="text-decoration:none"  onclick="updateAdmin('编辑','${ctx}/admin/toEdit?id=${adminPage.id}','600','400')" href="javascript:;" title="编辑">
	                                <i class="layui-icon">&#xe642;</i>
	                            </a>
	                            <a style="text-decoration:none"  onclick="updateAdmin('修改密码','${ctx}/admin/toPassword?id=${adminPage.id}','600','400')" href="javascript:;" title="修改密码">
	                                <i class="layui-icon">&#xe631;</i>
	                            </a>
          ...
          <!-- 分页处理开始 -->
		  <div align="center">
			<a  class="page" style="margin-left:25px;" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=1&&pageSize=${adminPage.pageSize}&&exist=${param.exist}">首页</a>
			<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.prePageNum}&&pageSize=${adminPage.pageSize}&&exist=${param.exist}">上一页</a>
			<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.nextPageNum}&&pageSize=${adminPage.pageSize}&&exist=${param.exist}">下一页</a>
			<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.totalPageNum}&&pageSize=${adminPage.pageSize}&&exist=${param.exist}">末页</a>
		  </div>
