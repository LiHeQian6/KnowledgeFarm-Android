			...
			layer.confirm('确认要删除吗？',function(index){
				if(id != "${admin.id}"){
					$.post("${ctx}/admin/deleteOneAdmin",{"id":id},function(data){
		    			if(data == "succeed"){
		    				window.location.href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.currentPageNum}&&pageSize=${adminPage.pageSize}&&exist=1";
		    			}else if(data == "fail"){
		    				layer.msg('删除失败');
		    			}
		    		})   
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock>
	            ...
	            <a href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.currentPageNum}&&pageSize=${adminPage.pageSize}&&exist=1">
          ...
          <!-- 分页处理开始 -->
		  <div align="center">
			<a  class="page" style="margin-left:25px;" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=1&&pageSize=${adminPage.pageSize}&&exist=1">首页</a>
			<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.prePageNum}&&pageSize=${adminPage.pageSize}&&exist=1">上一页</a>
			<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.nextPageNum}&&pageSize=${adminPage.pageSize}&&exist=1">下一页</a>
			<a  class="page" href="${ctx}/admin/findAdminPage?account=${param.account}&&pageNumber=${adminPage.totalPageNum}&&pageSize=${adminPage.pageSize}&&exist=1">末页</a>
		  </div>
