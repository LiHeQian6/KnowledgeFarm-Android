		...
		function deleteOneCrop(id){
			layer.confirm('确认要删除吗？',function(index){
				$.post("${ctx}/admin/crop/deleteOneCrop",{"id":id},function(data){
	    			if(data == "succeed"){
	    				window.location.href="${ctx}/admin/crop/findCropPage?name=${param.name}&&pageNumber=${cropPage.currentPageNum}&&pageSize=${cropPage.pageSize}&&exist=${param.exist}";
	    			}else if(data == "fail"){
	    				layer.msg('删除失败');
	    			}
	    		})                
        ...
        <div class="page-content">
          <div class="content">
            ...
            <xblock>
	            ...
	            <a href="${ctx}/admin/crop/findCropPage?name=${param.name}&&pageNumber=${cropPage.currentPageNum}&&pageSize=${cropPage.pageSize}&&exist=${param.exist}">
          ...
          <!-- 分页处理开始 -->
		  <div align="center">
			<a  class="page" style="margin-left:25px;" href="${ctx}/admin/crop/findCropPage?name=${param.name}&&pageNumber=1&&pageSize=${cropPage.pageSize}&&exist=${param.exist}">首页</a>
			<a  class="page" href="${ctx}/admin/crop/findCropPage?name=${param.name}&&pageNumber=${cropPage.prePageNum}&&pageSize=${cropPage.pageSize}&&exist=${param.exist}">上一页</a>
			<a  class="page" href="${ctx}/admin/crop/findCropPage?name=${param.name}&&pageNumber=${cropPage.nextPageNum}&&pageSize=${cropPage.pageSize}&&exist=${param.exist}">下一页</a>
			<a  class="page" href="${ctx}/admin/crop/findCropPage?name=${param.name}&&pageNumber=${cropPage.totalPageNum}&&pageSize=${cropPage.pageSize}&&exist=${param.exist}">末页</a>
		  </div>
