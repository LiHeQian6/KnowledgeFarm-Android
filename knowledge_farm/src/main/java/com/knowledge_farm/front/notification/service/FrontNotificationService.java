...
public class FrontNotificationService {
     ...
     */
    @Transactional(readOnly = false)
    public PushResult sendPush(JPushClient jPushClient, PushPayload pushPayload, String title, String content, Map<String, String> extrasMap, String... alias) throws Exception{
        PushResult result = jPushClient.sendPush(pushPayload);
        this.notificationService.addSystemNotification(title, content, extrasMap, alias);
        return result;
    }
