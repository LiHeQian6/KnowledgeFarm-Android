package com.atguigu.farm.userfriend.controller;

import com.atguigu.farm.entity.User;
import com.atguigu.farm.entity.UserVO;
import com.atguigu.farm.user.service.UserServiceImpl;
import com.atguigu.farm.userfriend.service.UserFriendServiceImpl;
import com.atguigu.farm.util.UserVOPage;
...
public class UserFriendController {
    ...
    public UserVOPage<UserVO> findUserFriend(@RequestParam("userId") Integer userId,
        ...
        UserVOPage<UserVO> userVOPage = new UserVOPage(pageNumber, pageSize);
        userVOPage.setTotalCount((int) page.getTotalElements());
    ...
    public UserVOPage<UserVO> findAllUser(@RequestParam(value = "accout", required = false) String account,
                                          @RequestParam(value = "pageNumber", defaultValue = "1") Integer pageNumber,
                                          @RequestParam(value = "pageSize", defaultValue = "4") Integer pageSize) {
