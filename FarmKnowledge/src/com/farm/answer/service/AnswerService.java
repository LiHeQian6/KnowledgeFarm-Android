...
public class AnswerService {
	...
	public Page<Chinese> OneUpChinese(int pageNumber, int pageSize){
		return new AnswerDao().getChineseWordOneUp(pageNumber, pageSize);
	}
	
	//一年级下册语文
	public Page<Chinese> OneDownChinese(int pageNumber, int pageSize){
		return new AnswerDao().getChineseWordOneDown(pageNumber, pageSize);
	}
	...
	//英语一年级下册
	public Page<English> OneDownEnglish(int pageNumber, int pageSize){
